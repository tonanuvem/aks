...
az aks create --resource-group akstraining-rg --name akstraining-cluster --node-count 2 --node-vm-size Standard_B2s --enable-addons monitoring --generate-ssh-keys
