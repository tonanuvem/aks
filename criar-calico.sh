...
az aks create --resource-group akstraining-rg-calico --name akstraining-cluster-calico --network-plugin azure --network-policy calico --node-count 2 --enable-addons monitoring --generate-ssh-keys
